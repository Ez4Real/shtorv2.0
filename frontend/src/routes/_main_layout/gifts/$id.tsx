...
function Product() {
  ...
  const [thumbsSwiper, setThumbsSwiper] = useState<swiper.Swiper | null>(null);
                  ...
                  {priceOption === "custom" && (
                    <Field
                      ...
                      invalid={
                        ...
                        amount > (currency.code === "uah" ? 100000 : 3000)
                      }
                      errorText={
                        <Text fontWeight="300">
                          {t(
                            ...
                            currency.code === "uah"
                              ? { min: 3333, max: 100000, currency: "₴" }
                              : { min: 100, max: 3000, currency: currency.symbol }
                          )}
                        </Text>
                      }
                      w="100%"
